...
/*@HungNgoc
* Date: 06/06/2014
* Mô tả: Tạo số dòng trên jxTable
* Cách sử dụng:
JScrollPane jScrollPane = new JScrollPane(table);
LineNumberTableRowHeader tableLineNumber = new LineNumberTableRowHeader(jScrollPane, table);
tableLineNumber.setBackground(new Color(240,240,240,240));
jScrollPane.setRowHeaderView(tableLineNumber);
* Nguồn: http://www.javarichclient.com/display-line-numbers-jtable/
*/
